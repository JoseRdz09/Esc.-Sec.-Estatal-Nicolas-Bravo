      ...
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex flex-grow items-center justify-center">
          <ul className="flex space-x-4">
            ...
            >
              ...
              {dropdownOpen && (
                <ul className="absolute left-0 bg-white text-black rounded-lg shadow-lg w-48 z-10 mt-2">
        ...
        <div className={`fixed top-0 right-0 w-64 h-full bg-persian-blue-950 text-white transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 z-40 md:hidden`}>
          ...
          <ul className="flex flex-col space-y-4 p-4 mt-16">
            <li>
              <Link to="/" onClick={scrollToTop} className="block text-white hover:text-gray-200">
                INICIO
              </Link>
            </li>
            <li
            ...
            <li>
              <Link to="/auth/login" className="block text-white hover:text-gray-200">
                INICIAR SESIÓN
              </Link>
            </li>
          </ul>
