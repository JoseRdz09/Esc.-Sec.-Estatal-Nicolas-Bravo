...
const Cards = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
    ...
    <ImageCard imageSrc="../img/home2.png" title="REINSCRIPCION" link="/reinscripcion" />
    <ImageCard imageSrc="../img/home2.png" title="CALENDARIO" link="/calendario" />
    <ImageCard imageSrc="../img/home2.png" title="LISTA DE ACEPTADOS" link="/lista-aceptados" />
  </div>
);
