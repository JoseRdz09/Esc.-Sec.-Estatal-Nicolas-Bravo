...
export default function Home() {
    ...
    const [user, setUser] = useState(null); // Ajusta esto según cómo manejas el estado del usuario
    ...
    useEffect(() => {
        // Aquí deberías definir cómo obtener el usuario. Por ejemplo:
    ...
    return (
        <main className='relative w-full flex flex-col items-center'>
            ...
            <Comunicados
                ...
                user={user}
                setAnnouncements={setAnnouncements} // Pasar la función de actualización del estado
            />
